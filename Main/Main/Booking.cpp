...
void startBookingFlow() {
    ...
    while (true) {
        ...
        Movie& selectedMovie = selectedTheater.halls[movieSelections[movieChoice - 1].hallIndex]
            .movies[movieSelections[movieChoice - 1].movieIndex];
